...
public:
    ...
    /** Set HS visualization band */
    void set_HS_visualization_spectral_band(int v)  {_M_visualization_spectral_band = v;}
...
signals:
    ...
    /** Send processed img (HS) */
    void newPreProcessedImg(_Processed_img_HS);
...
private:
    ...
    //HS visualization band
    int     _M_visualization_spectral_band;

    //Image buffer
    vector<_Processed_img>  _M_img_buffer;
