...
signals:
    ...
    /** new RGB mode or HS mode */
    void newRGBCameraMode(bool);
...
public slots:
    ...
    void onSimulateRealCamera(bool v)   {_M_simulate_real_camera = v;}
...
private:
    ...
    /** read HS img from directory containing img files (.tiff or .png) */
    void _Load_HS_DatasFromImgFiles();
    ...
    //Simulate a real camera (framerate)
    bool _M_simulate_real_camera;
