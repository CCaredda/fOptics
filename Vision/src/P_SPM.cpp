...
P_SPM::P_SPM(QObject *parent) : QObject(parent)
{
    ...
    // ReadVector(QString(PROPATH)+"/../files/SPM/z_threshold_5percent.txt",_M_z_thresh_possible_values);
    ReadVector(QString(QCoreApplication::applicationDirPath())+"/../share/files/SPM/z_threshold_5percent.txt",_M_z_thresh_possible_values);
}
...
{
    _M_z_thresh_possible_values.clear();
    // ReadVector(QString(PROPATH)+"/../files/SPM/z_threshold_"+QString::number(v)+"percent.txt",_M_z_thresh_possible_values);
    ReadVector(QString(QCoreApplication::applicationDirPath())+"/../share/files/SPM/z_threshold_"+QString::number(v)+"percent.txt",_M_z_thresh_possible_values);
